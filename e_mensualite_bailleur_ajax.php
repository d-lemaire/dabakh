...
$req=$db->prepare("SELECT CONCAT(CONCAT(locataire.prenom,' ', locataire.nom),' : ', type_logement.type_logement), logement.pu,  mensualite.type, mensualite.montant, mensualite.id_mensualite_bailleur, mensualite.mois, mensualite.annee
...
echo "<tr>";
	echo "<td colspan='4'>Sous Total </td>";
...
$depense_bailleur=$depense_bailleur."\n \n  <b>TOTAL  : ".number_format($montant_depense,0,'.',' ')."  </b>";
...
<div class="row">
	<h6 class="col m6 s12"><b><u>Dépenses Bailleur</u></b><?=nl2br($depense_bailleur) ?></h6>
</div>
<div class="row">
	<h3>
