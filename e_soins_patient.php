...
$req=$db->query('SELECT MAX(id) FROM `soins_externes`');
$donnees=$req->fetch();
$id=$donnees['0']+1;
?>
<!DOCTYPE html>
<html>
	<head>
		...
		<style type="text/css">
		            body {
		            background-image: url(<?=$image ?>e_analyse.jpg) ;
	...
	<body style="background-image: url(<?=$image ?>e_analyse.jpg) ;">
		...
		<div class="container white">
			<div class="row z-depth-5" style="padding: 10px;">
				<h3 class="center">Nouveau Soins externe</h3>
				<form class="col s12" method="POST" id="form" action="e_soins_patient_trmnt.php" >
					<div class="row">
