...
FROM `caisse_immo` 
WHERE caisse_immo.motif LIKE "Commision du locataire%" AND month(caisse_immo.date_operation)=?  AND year(caisse_immo.date_operation)=? ORDER BY caisse_immo.date_operation');
