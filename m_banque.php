...
<html>
	...
	<body style="background-image: url(<?=$image ?>m_banque.png);">
					...
					<div class="row">
						...
						<div class="col s6 m6 input-field">
							<select class="browser-default" name="section" required>
								...
								<option value="Approvisionnement" <?php if ($section=='Approvisionnement' ) { echo "selected" ; } ?>>Approvisionnement</option>
								<option value="Approvisionnement caisse" <?php if ($section=='Approvisionnement caisse' ) { echo "selected" ; } ?>>Approvisionnement caisse</option>
