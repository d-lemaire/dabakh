...
<html>
	...
	<body style="background-image: url(<?=$image ?>authentification_sante.png) ;">
		<div class="row" >
			<div class="col s12">
		...
		<div class="container white">
			<div class="row">
				<div class="col s12 m8 offset-m2 " id="index_form">
					<form method="POST" class="row" action="authentification_sante_trmnt.php">
						<h3 class="center-align" >Authentification Santé</h3>
