...
<html>
	...
	<body style="background-image: url('../css/images/i_facture_cons_d.jpg'); font: 12pt 'times new roman';">
		...
		<div class="container  white" style="padding:  10px">
			...
			<div class="row">
				<h5 class="col s7 offset-s2 " style="border: 2px solid black; border-radius: 10px">
					Nom : <?= $nom ?> <br>
					Prénom : <?= $prenom ?> <br>
			...
			<div class="row">
				...
				<br>
				<br>
				<div class="col s12 center" style="font: 20pt 'comic sans ms';">
