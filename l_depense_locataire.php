...
<html>
	...
	<body style="background-image: url(<?=$image ?>l_mensualite.jpg) ;">
		...
		<div class="row">
			<a class="btn col s8 m2 " href="e_depense_locataire.php">Nouvelle dépense</a>
			<h4 class="center #0d47a1 col s12 m9" style="color: white">Dépenses locataire effectuées pendant le mois de :</h4>
