		...
		<div class="container white">
			<div class="row">
				<div class="col s12 m8	  ">
					<p class="center-align">Soins à domicile</p>
					<table class="bordered highlight centered ">
						...
						<tbody>
							<?php
							include 'connexion.php';
							$reponse=$db->query('SELECT * FROM soins_domicile order by soins');
							while ($donnees= $reponse->fetch()) {
								$id=$donnees['0'];
									$soins=$donnees['1'];
									$pu=$donnees['2'];
									echo "<tr onmouseover='afficher_bt_modifier(this)' onmouseout='cacher_bt_modifier(this)'>";
										echo "<td> <a class='tooltipped' data-position='top' data-delay='50' data-tooltip='cliquez ici pour modifier' href='m_soins_domicile.php?id=$id'><i class='material-icons left'>edit</i>Modifier</a> </td>";
										echo "<td>".$soins."</td>";
