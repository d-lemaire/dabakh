...
<html>
	...
	<body style="background-image: url(<?=$image ?>l_d_regularisation.jpg);">
		<?php
		include 'verification_menu_sante.php';
		?>
		<div class="row">
			<h3 class="center #0d47a1 col s12" style="color: white">Demandes de régularisation du mois de</h3>
			<h5>
			<div class="row">
				...
				<table class="bordered striped highlight centered">
					<thead>
						<tr style="color: #0d47a1">
							<th>Date </th>
							<th>Patient</th>
							<th>Mise en observation</th>
							<th>Dernier réglement</th>
							<th>Montant</th>
						</tr>
					</thead>
					<tbody>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			$.ajax({
				type:'POST',
				url:'l_d_regularisation_ajax.php',
				data:'mois='+mois,
