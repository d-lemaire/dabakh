...
$req=$db->prepare("SELECT CONCAT(prenom,' ', nom), depense_locataire.id, depense_locataire.motif, depense_locataire.type_depense, depense_locataire.date_depense, depense_locataire.mois, depense_locataire.annee, depense_locataire.montant 
FROM `locataire`, depense_locataire 
WHERE depense_locataire.id_locataire=locataire.id AND depense_locataire.id=?");
...
<html>
	...
	<body style="background-image: url(<?=$image ?>moodif_maintenance.jpg) ;">
		<?php
		...
		<div class="container white">
			<div class="row z-depth-5" style="padding: 10px;">
				<h3 class="center">Modificaition dépense</h3>
