...
$req=$db->prepare('INSERT INTO caisse_sante(type, section, motif, montant,date_operation, id_user, pj) values (?,?,?,?,?,?,?) ');
...
if ($nbr>0) {
	if ($section=="Approvisionnement banque par caisse") 
	{
		...
		$motif="Approvisionnement de la banque par la caisse";
...
<script type="text/javascript">
	...
	window.location="e_caisse_sante.php";
</script>
<?php
}
?>