...
<html>
	<head>
		<title>Ordennance du <?=$date_consultation ?></title>
			...
			<tbody>
				<div class="container white">
					...
					<div class="row">
						...
						<br>
						<br>
						<h5 class="col s4 offset-s8" style="font: 16pt 'georgia'">
							<u><b>Le medecin</b></u>
						</h5>
						<br>
						<br>
						...
						<br><br>
						<br>
						<h6 class="col s12" style="font: 16pt 'georgia'">
							<b><u>NB </u></b>: Veuillez rapporter cette ordonnance à la prochaine consultation
						</h6>
					</div>
				</div>
			</tbody>
