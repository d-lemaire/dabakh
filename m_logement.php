...
<html>
	<head>
		<title>Modification d'un nouveau logement</title>
	...
	<body style="background-image: url(<?=$image ?>m_logement.jpg);">
		...
		<div class="container white">
			<div class="row z-depth-5" style="padding: 10px;">
				<h3 class="center">Modification d'un nouveau logement</h3>
				<form class="col s12" method="POST" id="form" action="m_logement_trmnt.php?id=<?=$id?>" >
					<div class="row">
						<div class="col s5 input-field">
							<select class="browser-default" name="bailleur" required>
								<option value="" disabled selected>Choisir le bailleur</option>
								<?php
								include 'connexion.php';
								$reponse=$db->query("SELECT * FROM bailleur  ORDER BY nom");
